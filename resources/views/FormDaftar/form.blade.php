...
@section('content')
            ...
            <div class="col-lg-15 mb-5">
                ...
                <h3 class="hero-titlee mb-3" data-aos="fade-up">
                    ...
                    <div class="bg-white p-4 border rounded-3 shadow-sm" data-aos="fade-up" data-aos-delay="100">
                        ...
                        <form action="{{ route('form.kirim') }}" method="POST">
                            @csrf
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control bg-light" id="pekerjaan_ortu"
                                    name="pekerjaan_ortu">
                            </div>
                            <div class="mb-3">
    ...
    <script>
        function kirimWhatsApp(event) {
            ...
            let pesan = 'Halo, berikut data pendaftaran:\n\n';
            ...
            const noHP = '6285727831822'; // Ganti 0 dengan 62
