    ...
    <div class="container d-flex align-items-center justify-content-between">
            ...
            <div class="offcanvas-header">
                <div class="offcanvas-header-logo">
                    <a class="logo-link" id="fbs__net-navbarsLabel" href="index.html">
                        <img class="logo dark img-fluid" src="{{ asset('images/logoysm.png') }}" style="width: 50px; height: 50px;" alt="FreeBootstrap.net image placeholder">
                        <img class="logo light img-fluid" src="{{ asset('images/logoysm.png') }}" style="width: 50px; height: 50px;" alt="FreeBootstrap.net image placeholder">
                    </a>
                </div>
        ...
        <div class="ms-auto w-auto">
            <div class="header-social d-flex align-items-center gap-1">
                ...
                <a class="btn btn-primary py-2 d-none d-lg-inline-block" href="{{ route('login') }}">Login</a>
