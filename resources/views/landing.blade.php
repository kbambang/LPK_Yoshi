...
<img class="logo dark img-fluid" 
     src="{{ asset('images/logoysm.png')}}" 
     width="50px" 
     height="50px" 
     style="filter: drop-shadow(2px 2px 4px rgba(0, 0, 0, 0.3));" 
     alt="FreeBootstrap.net image placeholder">            </a>
        <h3 class="font-sans font-bold text-4xl text-gray-800 tracking-wider uppercase mb-14"  style="margin-left: 10px;">
  YSM
</h3>
          <!-- End Logo-->
            ...
            <div class="offcanvas-header">
              <div class="offcanvas-header-logo">
                ...
                <a class="logo-link" id="fbs__net-navbarsLabel" href="index.html">
                  ...
                  <!-- logo dark--><img class="logo dark img-fluid" src="{{ asset('nova/assets/images/logo-dark.svg')}}" alt="FreeBootstrap.net image placeholder"> 
                  
                  <!-- logo light--><img class="logo light img-fluid" src="{{ asset('nova/assets/images/logo-light.svg')}}" alt="FreeBootstrap.net image placeholder"></a>
          ...
          <div class="ms-auto w-auto">
            ...
            <div class="header-social d-flex align-items-center gap-1"><a class="btn btn-primary py-2" href="#">Login</a>
          ...
          <div class="container">
            <div class="row">
              <div class="col-lg-8 mb-4 mb-lg-0">
                <div class="row">
                  <div class="col-lg-11"><span class="hero-subtitle text-uppercase" data-aos="fade-up" data-aos-delay="0">Selamat datang</span>
                                        <h3 class="hero-titlee mb-3" data-aos="fade-up" data-aos-delay="100">Belajar Bahasa Jepang & Kerja di Jepang Bersama LPK  </h3>
                    <h1 class="hero-title mb-3" data-aos="fade-up" data-aos-delay="100">Yoshi Sakatana Mandiri </h1>
                    <p class="hero-description mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="200">Raih impianmu bekerja di Jepang melalui pelatihan bahasa dan keterampilan dari mentor berpengalaman. Resmi, terpercaya, dan terbukti memberangkatkan alumni setiap tahun.</p>
                    <div class="cta d-flex gap-2 mb-4 mb-lg-5" data-aos="fade-up" data-aos-delay="300"><a class="btn" href="#">Daftar Sekarang</a><a class="btn btn-white-outline" href="#">Pilih Program 
  ...
  <li class="d-flex align-items-center gap-2">
   <span class="check-icon">
    ...
    <span class="text">Ratusan Alumni Telah Bekerja di Jepang</span>
              ...
              <div class="col-lg-4">
                <div class="hero-img"><img class="img-main img-fluid rounded-4" src="{{ asset('images/anime.png') }}" alt="Hero Image" data-aos="fade-in" data-aos-delay="500"></div>
              </div>
            </div>
          </div>
          <!-- End Hero-->
        ...
        <section class="about__v4 section" id="about">
          <div class="container">
            <div class="row">
              <div class="col-md-6 order-md-2">
                <div class="row justify-content-end">
                  <div class="col-md-11 mb-4 mb-md-0"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Tentang Kami</span>
                    <h2 class="mb-4" data-aos="fade-up" data-aos-delay="100">LPK Yoshi Sakatana Mandiri.</h2>
                    <div data-aos="fade-up" data-aos-delay="200">
                      <p>Adalah lembaga pendidikan dan pelatihan yang berkomitmen untuk mencetak generasi unggul dengan memberikan keterampilan praktis yang relevan dengan perkembangan dunia industri. Berdiri dengan visi untuk menciptakan individu yang terampil dan siap bersaing di pasar global, kami menyediakan berbagai program pelatihan yang dirancang untuk memenuhi kebutuhan tenaga kerja yang berkualitas.</p>
              ...
              <div class="col-md-6"> 
                <div class="img-wrap position-relative"><img class="img-fluid rounded-4" src="{{ asset('images/tentang.png')}}" alt="FreeBootstrap.net image placeholder" data-aos="fade-up" data-aos-delay="0">
                  <div class="mission-statement p-4 rounded-4 d-flex gap-4" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <div>
                      ...
                      <p class="fs-5 mb-0">Kami berkomitmen untuk menjadi mitra terbaik bagi para pemuda Indonesia yang ingin bekerja di Jepang. Dengan pendekatan pembelajaran yang menyeluruh dan bimbingan penuh, kami siap mengantarkan Anda meraih mimpi hingga Negeri Sakura</p>
                    </div>
                  </div>
                </div>
              </div>
                      ...
                      <div class="row"> 
                        <div class="col-lg-11">
                          <div class="h-100 flex-column justify-content-between d-flex">
                            <div>
                              <h2 class="mb-4" style="color: white">Mengapa Memilih Kami</h2>
                              <p class="mb-5" style="color: white">LPK Yoshi Sakatana Mandiri bukan hanya sekadar lembaga pendidikan dan pelatihan, melainkan mitra terpercaya dalam perjalanan Anda untuk mencapai kesuksesan LPK Yoshi Sakatana Mandiri adalah pilihan tepat untuk Anda yang ingin berkembang dan mencapai tujuan karir Anda!</p>
                            </div>
                            <div class="align-self-start"><a class="glightbox btn btn-play d-inline-flex align-items-center gap-2" href="https://youtu.be/OKIwI3Kcv-M?si=9pmTD16LyQwom4hs" data-gallery="video"><i class="bi bi-play-fill"></i> Play Video</a></div>
                          </div>
                        </div>
                      </div>
                    </div>
                        ...
                        <div class="col-lg-11">
                          <div class="row"  style="color: white">
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="0">
                              ...
                              <h3 class="fs-6 fw-bold mb-3"  style="color: white">Pelatihan Bahasa Jepang Intensif</h3>
                              <p>Dapatkan pelatihan bahasa Jepang dari pengajar profesional untuk mempersiapkan diri secara linguistik dan budaya.</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="100">
                              <div class="icon text-center mb-4"><i class="bi bi-graph-up fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3"  style="color: white">Penempatan Legal & Resmi ke Jepang</h3>
                              <p>Kami bekerja sama dengan lembaga resmi untuk memastikan proses pemagangan sesuai aturan dan legalitas</p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="200">
                              <div class="icon text-center mb-4"><i class="bi bi-headset fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3"  style="color: white">Peluang Karir Internasional</h3>
                              <p>Buka jalan menuju karir global dengan pengalaman kerja langsung di Jepang.<p>
                            </div>
                            <div class="col-sm-6" data-aos="fade-up" data-aos-delay="300">
                              <div class="icon text-center mb-4"><i class="bi bi-shield-lock fs-4"></i></div>
                              <h3 class="fs-6 fw-bold mb-3"  style="color: white">Alumni Sukses dan Jaringan Kuat</h3>
                              <p>Bergabung dengan komunitas alumni kami yang telah sukses di Jepang dan kembali membangun karir di Indonesia</p>
                            </div>
                          </div>
                        </div>
                      </div>
    ...
    <div class="clients-slider">
      <div class="clients-track">
        ...
        <section class="section pricing__v2" id="pricing">
          <div class="container">
            <div class="row mb-5">
              <div class="col-md-10 mx-auto text-center"><span class="subtitle text-uppercase mb-3" data-aos="fade-up" data-aos-delay="0">Program Pelatihan</span>
                <h2 class="mb-3" data-aos="fade-up" data-aos-delay="100">Pelatihan dan Magang di LPK Yoshi Sakatana Mandiri </h2>
                <p data-aos="fade-up" data-aos-delay="200">LPK Yoshi Sakatana Mandiri menawarkan berbagai program pelatihan dan magang yang dirancang untuk memberikan keterampilan praktis yang relevan dengan industri. Kami juga menyediakan kesempatan untuk belajar bahasa Jepang melalui program Nihon Go Gakko.</p>
              </div>
            </div>
            <div class="row">
            ...
            <div class="row g-md-5">
              <div class="col-md-6 col-lg-3">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative" data-aos="fade-up" data-aos-delay="0">
                  <div data-aos="fade-right" data-aos-delay="500"><img class="arch-line" src="{{ asset('nova/assets/images/arch-line.svg')}}" alt="FreeBootstrap.net image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">1</span>
                  <div>
              ...
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="600">
                <div class="step-card reverse text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1100"><img class="arch-line reverse" src="{{ asset('nova/assets/images/arch-line-reverse.svg')}}" alt="FreeBootstrap.net image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">2</span>
              ...
              <div class="col-md-6 col-lg-3" data-aos="fade-up" data-aos-delay="1200">
                <div class="step-card text-center h-100 d-flex flex-column justify-content-start position-relative">
                  <div data-aos="fade-right" data-aos-delay="1700"><img class="arch-line" src="{{ asset('nova/assets/images/arch-line.svg')}}" alt="FreeBootstrap.net image placeholder"></div><span class="step-number rounded-circle text-center fw-bold mb-5 mx-auto">3</span>
            ...
            <div class="row g-4" data-masonry="{&quot;percentPosition&quot;: true }">
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="0">
                <div class="testimonial rounded-4 p-4">
                  ...
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img"><img class="rounded-circle img-fluid" src="{{ asset('nova/assets/images/person-sq-2-min.jpg')}}" alt="FreeBootstrap.net image placeholder"></div>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="100">
                <div class="testimonial rounded-4 p-4">
                  ...
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img"><img class="rounded-circle img-fluid" src="{{ asset('nova/assets/images/person-sq-1-min.jpg')}}" alt="FreeBootstrap.net image placeholder"></div>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="200">
                <div class="testimonial rounded-4 p-4">
                  ...
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img"><img class="rounded-circle img-fluid" src="{{ asset('nova/assets/images/person-sq-5-min.jpg')}}" alt="FreeBootstrap.net image placeholder"></div>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="300">
                <div class="testimonial rounded-4 p-4">
                  ...
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img"><img class="rounded-circle img-fluid" src="{{ asset('nova/assets/images/person-sq-3-min.jpg')}}" alt="FreeBootstrap.net image placeholder"></div>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="400">
                <div class="testimonial rounded-4 p-4">
                  ...
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img"><img class="rounded-circle img-fluid" src="{{ asset('nova/assets/images/person-sq-7-min.jpg')}}" alt="FreeBootstrap.net image placeholder"></div>
              ...
              <div class="col-md-6 col-lg-4" data-aos="fade-up" data-aos-delay="500">
                <div class="testimonial rounded-4 p-4">
                  ...
                  <div class="testimonial-author d-flex gap-3 align-items-center">
                    <div class="author-img"><img class="rounded-circle img-fluid" src="{{ asset('nova/assets/images/person-sq-8-min.jpg')}}" alt="FreeBootstrap.net image placeholder"></div>
